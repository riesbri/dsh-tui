...
- **`/goal <objective>` starts an automatic agent run.** That is the harness's goal driver, not this interface, and nothing here warns you before it begins. See [Usage → Commands](usage.md#commands).
